...
public class signIn extends javax.swing.JFrame {
    ...
    user_staff dashStaff = new user_staff();
    public static boolean signIn(String username, String password) {
        Connection connect;
        connectDB connector = new connectDB();
        String query = "SELECT * FROM users_cams WHERE username = ? AND password = ?";
    ...
    private void SIGNIN1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SIGNIN1MouseClicked
        ...
        String password = new String(userSignIn.getText()).trim();
